...
const UsedCar = () => {
  return (  
    ...
    <div className="used-car">
      ...
      <b>It&rsquo;s a car</b> known for its spacious interior, advanced safety features, and smooth handling, making it a popular choice for daily commuting and family outings. </p>
      <div className="price">
        <p>PKR 4,000,000</p>
